// src/components/ui/Toast.jsx — Notificações visuais flutuantes
  ...
  return (
    <div className="fixed top-6 left-1/2 -translate-x-1/2 z-[999999] animate-slide-down pointer-events-none">
      <div
        ...
        } text-white px-6 py-4 rounded-2xl shadow-2xl flex items-center gap-3 font-bold text-sm max-w-sm`}
      >
